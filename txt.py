...
def create_font_misaki_images(output_dir: str) -> None:
    pygame.font.init()
    # フォントを使用。サイズ64
    font = pygame.font.Font("data/font/misaki/misaki_gothic_2nd.ttf", 64)
...
if __name__ == "__main__":
    ...
    os.makedirs("data/assets/misaki_64", exist_ok=True)
    ...
    create_font_misaki_images("data/assets/misaki_64")
