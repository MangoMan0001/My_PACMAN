...
class ResultScene(Scene):
    ...
    Attributes:
        ...
        title_img (pygame.Surface): titleのテキスト画像
    ...
    def __init__(self, config: ConfigModel, score: int, score_manager: ScoreManager, title: str):
        ...
        self.title_img = title_font.render_text(title)
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        _, ty = cx // 2, cy // 2
        _, zy = cx // 3, cy // 3
        title_x = cx - self.title_img.get_width() // 2
        title_y = cy - self.title_img.get_height() // 2
        ...
        screen.blit(self.title_img, (title_x, title_y - ty))
        if not self.is_save:
